...
(function(){
  ...
  var s=document.createElement('style');s.textContent='.logo{font-family:"Great Vibes",cursive !important;font-size:3rem !important;font-weight:400 !important;letter-spacing:1px}.logo em{font-style:normal !important}header>div{display:flex !important;align-items:center !important;justify-content:space-between !important;flex-wrap:wrap;gap:10px;padding:12px 20px}.logo{display:flex !important;align-items:center !important;gap:8px;text-decoration:none !important}.logo span{color:#2563eb !important}.logo em{color:#10b981 !important}.logo img{height:85px !important;border-radius:50% !important}';(document.head||document.documentElement).appendChild(s);
})();
